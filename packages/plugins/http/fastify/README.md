...
**Fastify HTTP server integration for Stratix applications**

[![npm version](https://img.shields.io/npm/v/@stratix/http-fastify.svg)](https://www.npmjs.com/package/@stratix/http-fastify)
...
`@stratix/http-fastify` is a HTTP server plugin for the Stratix framework.
