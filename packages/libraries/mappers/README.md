...
**Entity-to-DTO mapping utilities for Stratix applications**

[![npm version](https://img.shields.io/npm/v/@stratix/mappers.svg)](https://www.npmjs.com/package/@stratix/mappers)
...
`@stratix/mappers` is a mapping plugin for the Stratix framework.
